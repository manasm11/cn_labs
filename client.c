...
int main()
{
    ...
    serverAddr.sin_port = htons(SERVER_PORT);                //You can change port number here
    serverAddr.sin_addr.s_addr = inet_addr(SERVER_ADDRESS); //Specify server's IP address here
